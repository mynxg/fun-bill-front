...
const ChildrenInfo: React.FC = () => {
  ...
  return (
    <PageContainer>
      ...
      <UpdateModal
        columns={columns}
        onSubmit={async(values:USERTESTAPI.UserVO)=>{
          // handleUpdate(values)
        }
        }
        onCancel={() => {
      ...
      {/* <CreateModal columns={columns} onCancel={()=>{handleModalOpen(false)}} onSubmit={async (values:USERTESTAPI.UserVO)=>{await handleAdd(values)}} visible={createModalOpen} file={true}/>
